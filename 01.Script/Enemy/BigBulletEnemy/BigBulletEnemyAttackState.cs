...
namespace YH.Enemy
{
    public class BigBulletEnemyAttackState : EntityState
    {
        private BigBulletEnemy _enemy;
        private EntityMover _mover;

        public BigBulletEnemyAttackState(Entity entity, AnimParamSO animParam) : base(entity, animParam)
        {
            _enemy = entity as BigBulletEnemy;
